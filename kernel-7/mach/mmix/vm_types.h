 ...
 *	Date: 1985
 *
 *	Header file for VM data types.  MMIX version.
 */

#ifndef	_MACH_MMIX_VM_TYPES_H_
#define _MACH_MMIX_VM_TYPES_H_
 ...
 *
 * MMIX is a 64-bit architecture, so natural_t is 64 bits.
 */
