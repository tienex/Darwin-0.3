...
/*
 * LoongArch general purpose thread state (32-bit)
 */
struct loongarch_thread_state {
...
typedef struct loongarch_thread_state loongarch_thread_state_t;

/*
 * LoongArch 64-bit general purpose thread state
 */
struct loongarch64_thread_state {
...
typedef struct loongarch64_thread_state loongarch64_thread_state_t;

/*
 * LoongArch floating point thread state
 * This structure should be double-word aligned for performance
 */
struct loongarch_float_state {
	double f0;
	double f1;
	double f2;
	double f3;
...
typedef struct loongarch_float_state loongarch_float_state_t;

/*
 * LoongArch exception state
 */
struct loongarch_exception_state {
...
typedef struct loongarch_exception_state loongarch_exception_state_t;
