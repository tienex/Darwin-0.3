...
static const NXArchInfo ArchInfoTable[] = {
    ...
    {"mmix",   CPU_TYPE_MMIX,    CPU_SUBTYPE_MMIX_ALL,     NX_BigEndian,
	 "MMIX"},
    {"ia64",   CPU_TYPE_IA64,    CPU_SUBTYPE_IA64_ALL,     NX_LittleEndian,
	 "Intel Itanium (IA-64)"},
    {"itanium", CPU_TYPE_IA64,   CPU_SUBTYPE_IA64_ITANIUM, NX_LittleEndian,
	 "Intel Itanium"},
    {"itanium2", CPU_TYPE_IA64,  CPU_SUBTYPE_IA64_ITANIUM2, NX_LittleEndian,
	 "Intel Itanium 2"},
