 ...
 */
/*
 * Natural alignment of shorts and longs (for RISC-V)
 */

/*
 * RISC-V supports unaligned access in hardware (with performance penalty)
 * so these can be simple direct accesses
 */
